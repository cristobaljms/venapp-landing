...
const defaultOptions = {
  container: typeof window != 'undefined' ? document.body : {},
...
export default class PanelSnap {
  ...
  constructor(options) {
    ...
    console.log("PANEL LIST", document.querySelectorAll("section"));
    this.events = [];
    this.isEnabled = true;
  ...
  findSnapTarget() {
    ...
    if (elementFillsContainer(this.container, visiblePanel)) {
      ...
      console.log("IS ENTER IF ELEMENT FILLS CONTAINER")
      return;
    }
  ...
  snapToPanel(panel, toBottom = false, toRight = false) {
    ...
    console.log("SNAP TO PANEL",this.animation)
