...
const IndexPage = () => {
  ...
  return (
    ...
    >
      ...
      <section ref={stepref_1} className="section section1">
        <Section1 />
      </section>
      <section id="descubre" ref={stepref_2} className="section section2">
        <Section2 />
      </section>
      <section ref={stepref_3} className="section section3">
        <Section3 />
      </section>
      <section ref={stepref_4} className="section section4">
        <Section4 />
      </section>
